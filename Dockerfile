...
WORKDIR /src
COPY ["Sml.Poc.NetCore.GithubActions/Sml.Poc.NetCore.GithubActions.Api.csproj", "Sml.Poc.NetCore.GithubActions/"]
RUN dotnet restore "./Sml.Poc.NetCore.GithubActions/./Sml.Poc.NetCore.GithubActions.Api.csproj"
COPY . .
